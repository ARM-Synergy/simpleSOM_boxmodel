...
#xx = np.array([3.513,0.0111,34.00,1.63,10.,7040.,2600.,10.])
#x0 = np.array([4.819,10.,0.0,1.11757,149.479,10.,10.,98.59])
#xx = np.array([4.80663,10.00000,0.00000,1.11351,149.60721,12.06393,10.89173,98.58412]) #fit
xx = np.array([4.819,10.,0.,1.118,0.558,0.037,0.037,0.368]) #fwd
