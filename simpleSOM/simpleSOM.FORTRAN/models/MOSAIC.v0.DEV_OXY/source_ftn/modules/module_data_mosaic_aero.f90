      ...
      USE mod_MAIN,     ONLY: nCOMP,naerbin
...
! number of aerosol bins
      ...
      REAL(R8),SAVE :: NUC_in
      REAL(R8),SAVE :: NUC_T0_in,NUC_T1_in
...
! mosaic-specific parameters
      ...
      integer, parameter :: ngas_soa = nCOMP	! volatile soa species that have a gaseous counterpart (the org products)
...
! MOSAIC variables
      ...
      REAL(R8),ALLOCATABLE,SAVE :: jk_PARMOLE_OXY(:,:)
