...
!------------------------------------------------------------------------
      ...
      REAL(R8),SAVE :: p_OXY(nCOMP)
      REAL(R8),SAVE :: d_OXY(nCOMP)

      REAL(R8),SAVE :: j_GASMOLE_OXY(nCOMP)
      REAL(R8),SAVE :: j_GASMOLE_SOM(nCOMP)

      REAL(R8),SAVE :: j_WLLMOLE_OXY(nCOMP)
